...
public abstract class DataAdapter extends BaseAdapter {
    ...
    DataAdapter(Context context){
        ...
        album.addTrack(new Track("Track2", R.raw.eine));
        album.addTrack(new Track("Track3", R.raw.eine));
        mAlbums.add(album);
        album = new Album("Abba","Sample0", R.drawable.sample_1);
        album.addTrack(new Track("Track4", R.raw.eine));
        album.addTrack(new Track("Track5", R.raw.eine));
        mAlbums.add(album);
        album = new Album("Belga","Sample2", R.drawable.sample_2);
        album.addTrack(new Track("Track6", R.raw.eine));
        album.addTrack(new Track("Track7", R.raw.eine));
        album.addTrack(new Track("Track8", R.raw.eine));
        album.addTrack(new Track("Track9", R.raw.eine));
        album.addTrack(new Track("Track10", R.raw.eine));
        mAlbums.add(album);
        album = new Album("Belga","Sample1", R.drawable.sample_3);
        album.addTrack(new Track("Track11", R.raw.eine));
        album.addTrack(new Track("Track12", R.raw.eine));
        mAlbums.add(album);
        album = new Album("Korn","Sample1", R.drawable.sample_4);
        album.addTrack(new Track("Track13", R.raw.eine));
        album.addTrack(new Track("Track14", R.raw.eine));
        mAlbums.add(album);
    }
}